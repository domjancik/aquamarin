...
@OptionsPanelController.TopLevelRegistration(categoryName = "#OptionsCategory_Name_Database",
iconBase = "com/magnetpwns/derbydb/database32.png",
keywords = "#OptionsCategory_Keywords_Database",
keywordsCategory = "Database")
@org.openide.util.NbBundle.Messages({"OptionsCategory_Name_Database=Database", "OptionsCategory_Keywords_Database=database sql"})
