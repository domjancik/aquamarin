 ...
 * @author MagNet
 */
public class ProformaPreviewDialog extends AbstractProformaViewDialog<ProformaInvoice> {

    public ProformaPreviewDialog(ProformaInvoice document) {
        super("Náhled proforma faktury", document);
    }
    ...
    protected JPanel innerPane() {
        ...
        innerPane.add(new JLabel("Opravdu si přejete vytvořit následující proforma fakturu?"));
